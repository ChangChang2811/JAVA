...
public class Program {
    public static void main(String[] args) {
        ...
        // 4. sắp xếp giảm dần theo tuổi rồi in kết quả
        StudentUtils.sortByAgeDescending(list);
        StudentUtils.print(list);
       
        // 5. tính điểm trung bình của toàn bộ danh sách rồi in kết quả
        ...
        // 6. lấy danh sách TÊN học sinh giỏi rồi in kết quả
